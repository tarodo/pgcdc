...
соединения (`--reconnect-initial-ms`, `--reconnect-max-ms`), ограниченное бюджетом
терпение к слоту, который отвечает гонкой "занят" (`--slot-busy-budget-ms`) —
чтобы вечно занятый чужим потребителем слот не маскировался под бесконечно
разрешающуюся гонку с нашей же прошлой сессией, штатная остановка по
