...
терпения сбрасывается на каждом успешном старте сессии, поэтому редкие,
никак не связанные между собой гонки, случившиеся за месяцы работы
долгоживущего процесса, не суммируются в один фатальный выход.
