...
соединения, штатная остановка по SIGTERM/SIGINT — принятое доводится до барьера,
подтверждается, и процесс завершается с нулевым кодом возврата, — и переживание
