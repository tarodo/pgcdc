...
rewrite of the source document. By the end there were thirty-six of them (`Q1`–`Q36`), each
...
## Thirty-six decisions, six stages
...
language model, on request, from a prompt I wrote; the thirty-six decisions that followed, the
